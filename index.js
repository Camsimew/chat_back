...
//Config DB // Tiene que ser despues de la lectura de fichero de entorno. Sirve para ejecutar el DB
...
io.on('connection', async (socket) => {
    ...
    socket.on('disconnect', () => {
        io.emit('chat_message:_server', {
            username: 'INFO',
            message: 'Se ha desconectado un usuario'
        });
        io.emit('clients_online', io.engine.clientsCount); // Se actualiza el número de clientes
    });
